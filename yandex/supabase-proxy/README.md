...
При сетевом сбое/5xx клиент делает один прямой запрос с тем же телом и ревизией.
401/403/409/429 от Supabase не повторяются. Если первая запись прошла, но ответ
