const CACHE='starosta-v18';
const SHELL=['./','./index.html','./app.js?v=teacher-info-1','./cloud.js?v=ios-safe-1','./local-copy.js','./dialogs.js','./config.js?v=yandex-refresh-1','./data/teachers.json','./manifest.webmanifest','./icon-192.png'];
