const CACHE='starosta-v35';
const SHELL=['./','./index.html','./styles.css?v=ui9','./app.js?v=ui9','./cloud.js?v=ui9','./local-copy.js','./dialogs.js?v=ui9','./config.js?v=ui9','./api-transport.js?v=ui9','./manifest.webmanifest','./icon-192.png'];
