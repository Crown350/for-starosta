const CACHE='starosta-v15';
const SHELL=['./','./index.html','./app.js?v=automatic-schedule-1','./cloud.js?v=automatic-schedule-1','./local-copy.js','./dialogs.js','./config.js','./manifest.webmanifest','./icon-192.png'];
