const CACHE='starosta-v16';
const SHELL=['./','./index.html','./app.js?v=yandex-refresh-1','./cloud.js?v=yandex-refresh-1','./local-copy.js','./dialogs.js','./config.js?v=yandex-refresh-1','./manifest.webmanifest','./icon-192.png'];
