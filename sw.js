const CACHE='starosta-v23';
const SHELL=['./','./index.html','./app.js?v=teacher-format-1','./cloud.js?v=guest-more-1','./local-copy.js','./dialogs.js','./config.js?v=proxy-1','./api-transport.js?v=proxy-1','./data/teachers.json','./manifest.webmanifest','./icon-192.png'];
