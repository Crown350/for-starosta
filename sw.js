const CACHE='starosta-v17';
const SHELL=['./','./index.html','./app.js?v=yandex-refresh-1','./cloud.js?v=ios-safe-1','./local-copy.js','./dialogs.js','./config.js?v=yandex-refresh-1','./manifest.webmanifest','./icon-192.png'];
