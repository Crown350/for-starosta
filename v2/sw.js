...
const SHELL=["v2/","v2/index.html","schedule.json","data/curriculum.json","ui-mode.js","whats-new.js","icon-180.png","config.js?v=proxy-1","api-transport.js?v=failover-2","local-copy.js","v2/manifest.webmanifest","v2/styles.css?v=weektable6","config.js?v=ui11","api-transport.js?v=ui11","v2/app.js?v=weektable6","v2/dialogs.js?v=ui11","v2/cloud.js?v=ui11"].map(path=>new URL(path,BASE).href);
